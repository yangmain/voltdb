...
public abstract class AbstractVoltDBPAggregate extends Aggregate implements VoltDBPRel {
    ...
    public AbstractPlanNode toPlanNode() {
        final AbstractPlanNode apn = toPlanNode(getInput().getRowType());
    ...
    AbstractPlanNode toPlanNode(RelDataType inputRowType) {
        ...
        for(AggregateCall aggrCall : getAggCallList()) {
            ...
            if (aggrType == null) {
                throw new /*CalcitePlanningException*/RuntimeException("Unsupported aggregate function: " + aggrCall.getAggregation().kind.lowerName);
            }
