...
public class VoltDBPTableIndexScan extends AbstractVoltDBPTableScan {
    ...
    final private double GEO_INDEX_ARTIFICIAL_TUPLE_DISCOUNT_FACTOR = 0.08;
    ...
    public AbstractPlanNode toPlanNode() {
        ...
        StmtTableScan tableScan = new StmtTargetTableScan(m_voltTable.getCatTable(), m_voltTable.getCatTable().getTypeName(), 0);
    ...
    public double estimateRowCount(RelMetadataQuery mq) {
        ...
        if (m_index.getUnique() && (colCount == keyWidth)) {
            ...
            tuplesToRead += (int) (Constants.MAX_TABLE_ROW_COUNT * 0.90 * Math.pow(0.10, keyWidth));
            ...
            tuplesToRead = Math.max(4, tuplesToRead); // i.e. costing 1 unit more than a covered unique btree.
        }
    ...
    @Override
    public AbstractVoltDBTableScan copyWithProgram(RelTraitSet traitSet, RexProgram newProgram, RexBuilder rexBuilder) {
